...
mixin _$QRISState {
  ...
  EmvqrModel? get data => throw _privateConstructorUsedError;
...
class _$QRISStateImpl implements _QRISState {
  const _$QRISStateImpl(
      {this.isScanning = false, this.data, this.amount, this.errorMessage});

  @override
  @JsonKey()
  final bool isScanning;
  @override
  final EmvqrModel? data;
  @override
  final double? amount;
  @override
  ...
  @override
  String toString() {
    return 'QRISState(isScanning: $isScanning, data: $data, amount: $amount, errorMessage: $errorMessage)';
  }
...
abstract class _QRISState implements QRISState {
  const factory _QRISState(
      {final bool isScanning,
      final EmvqrModel? data,
      final double? amount,
      final String? errorMessage}) = _$QRISStateImpl;
