...
class _$UserStateImpl extends _UserState {
  const _$UserStateImpl({this.user, this.authState = AuthState.loading})
      : super._();
  ...
  @override
  String toString() {
    return 'UserState(user: $user, authState: $authState)';
  }
...
abstract class _UserState extends UserState {
  const factory _UserState({final Pilot? user, final AuthState authState}) =
      _$UserStateImpl;
